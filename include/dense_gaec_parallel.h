...
namespace DENSE_MULTICUT {
    ...
    std::vector<size_t> dense_gaec_parallel_hnswlib(const size_t n, const size_t d, std::vector<float> features, const std::string index_str, const bool track_dist_offset = false);
